return {
    ...
    config = function()
        ...
        vim.api.nvim_set_hl(0, "MyRenderMarkdownH1Bg",
            { fg = RenderMarkdownH1Fg, bg = color.composeColor(RenderMarkdownH1Fg, NormalBg, 0.85), bold = false, cterm = { bold = false } })
        vim.api.nvim_set_hl(0, "MyRenderMarkdownH2Bg",
            { fg = RenderMarkdownH2Fg, bg = color.composeColor(RenderMarkdownH2Fg, NormalBg, 0.85), bold = false, cterm = { bold = false } })
        vim.api.nvim_set_hl(0, "MyRenderMarkdownH3Bg",
            { fg = RenderMarkdownH3Fg, bg = color.composeColor(RenderMarkdownH3Fg, NormalBg, 0.85), bold = false, cterm = { bold = false } })
        vim.api.nvim_set_hl(0, "MyRenderMarkdownH3Bg",
            { fg = RenderMarkdownH4Fg, bg = color.composeColor(RenderMarkdownH4Fg, NormalBg, 0.85), bold = false, cterm = { bold = false } })
        vim.api.nvim_set_hl(0, "MyRenderMarkdownH5Bg",
            { fg = RenderMarkdownH5Fg, bg = color.composeColor(RenderMarkdownH5Fg, NormalBg, 0.85), bold = false, cterm = { bold = false } })
        vim.api.nvim_set_hl(0, "MyRenderMarkdownH6Bg",
            { fg = RenderMarkdownH6Fg, bg = color.composeColor(RenderMarkdownH6Fg, NormalBg, 0.85), bold = false, cterm = { bold = false } })

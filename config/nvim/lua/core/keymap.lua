...
keymap.set("n", "gj", "j", { desc = "Down" })
keymap.set("n", "gk", "k", { desc = "Up" })

keymap.set("n", "L", "$")
keymap.set("n", "H", "^")
keymap.set("n", "J", "5gj", {desc = "Down 5"})
keymap.set("n", "K", "5gk", {desc = "Up 5"})

keymap.set("v", "L", "$")
keymap.set("v", "H", "^")
keymap.set("v", "J", "5gj", {desc = "Down 5"})
keymap.set("v", "K", "5gk", {desc = "Up 5"})
